...
TASK_REGISTRY.update(
    {
        ...
        "hellaswag_zeroshot_full": hellaswag_std.HellaSwagStd,
        "hellaswag_mc_zeroshot_full": hellaswag_std.HellaSwagMCStd,
        ...
        **mmlu_std.create_all_tasks(),
        ...
        "winogrande_zeroshot": winogrande_std.WinograndeStd,
        "winogrande_mc_zeroshot": winogrande_std.WinograndeMCStd,
